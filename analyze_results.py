...
METRICS = [
    ...
    ("totalTsvCount", "TSV count"),
    ("thermalCost", "Thermal hotspot proxy"),
    ("tsvOverlapCost", "TSV overlap penalty"),
    ("chipArea", "Chip area"),
...
def read_summary(path):
    ...
    return {
        ...
        "totalTsvCount": data.get("totalTsvCount"),
        "thermalCost": data.get("thermalCost"),
        "tsvOverlapCost": data.get("tsvOverlapCost"),
        ...
        "tsvWeight": data.get("tsvWeight"),
        "thermalWeight": data.get("thermalWeight"),
        "tsvKeepoutWeight": data.get("tsvKeepoutWeight"),
        "thermalTsvBenefitWeight": data.get("thermalTsvBenefitWeight"),
        "tsvDiameter": data.get("tsvDiameter"),
        "tsvKeepoutRadius": data.get("tsvKeepoutRadius"),
